...
<script lang="ts" context="module">
  export type FormStepFlowType = "constrained" | "free";
</script>
...
<script lang="ts">
  ...
  // whether access to certain steps are externally constrained or all steps can be immediately accessed
  export let type: FormStepFlowType | undefined;
